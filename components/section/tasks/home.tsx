    ...
    <div className="min-h-screen bg-gradient-to-b from-navy-900 to-navy-950 text-white py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <p className="text-sm uppercase tracking-wider mb-4">OUR BENEFITS</p>
          ...
          <p className="max-w-2xl mx-auto text-gray-300">
            Unlock unprecedented growth by integrating AI Agents into your operations. Experience the transformative
            benefits:
          </p>
        </div>
